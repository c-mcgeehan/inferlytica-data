DESC TABLE DATA_PROVIDER_SSA.ANALYTICS.FIRST_NAME_GENDER_QUANTITY_LOOKUP;

SELECT *
FROM DATA_PROVIDER_SSA.ANALYTICS.FIRST_NAME_AGE_BUCKET_LOOKUP;

DROP TABLE DATA_PROVIDER_SSA.ANALYTICS.FIRST_NAME_AGE_BUCKET_LOOKUP;

create or replace dynamic table DATA_PROVIDER_SSA.ANALYTICS.FIRST_NAME_AGE_BUCKET_SPECIFIC_LOOKUP
...
select
    ...
    when MAX_PROBABILITY >= 0.85 then 'HIGH'
    when MAX_PROBABILITY >= 0.70 then 'MEDIUM'
    when MAX_PROBABILITY >= 0.60 then 'LOW'
    else 'AMBIGUOUS'
